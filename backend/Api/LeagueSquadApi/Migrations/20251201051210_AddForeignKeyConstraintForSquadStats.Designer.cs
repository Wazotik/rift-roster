...
namespace LeagueSquadApi.Migrations
{
    ...
    [Migration("20251201051210_AddForeignKeyConstraintForSquadStats")]
    partial class AddForeignKeyConstraintForSquadStats
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LeagueSquadApi.Data.Models.SquadAggregatedStats", b =>
                {
                    ...
                    b.Property<string>("StatSquadMember")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("stat_squad_member");
