...
namespace LeagueSquadApi.Migrations
{
    ...
    [Migration("20251102221030_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeagueSquadApi.Models.Match", b =>
                {
            ...
            modelBuilder.Entity("LeagueSquadApi.Models.MatchTimeline", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("match_id");
            ...
            modelBuilder.Entity("LeagueSquadApi.Models.Participant", b =>
                {
            ...
            modelBuilder.Entity("LeagueSquadApi.Models.Player", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("puuid");
            ...
            modelBuilder.Entity("LeagueSquadApi.Models.Squad", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LeagueSquadApi.Models.SquadMatch", b =>
                {
            ...
            modelBuilder.Entity("LeagueSquadApi.Models.SquadMember", b =>
                {
                    b.Property<long>("SquadId")
                        .HasColumnType("bigint")
                        .HasColumnName("squad_id");
