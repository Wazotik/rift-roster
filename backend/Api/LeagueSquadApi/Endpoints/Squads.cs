...
namespace LeagueSquadApi.Endpoints
{
    public static class Squads
    {
        public static void RegisterSquadEndpoints(this IEndpointRouteBuilder routes)
        {
            ...
            // Create a squad
            squads.MapPost("", async (SquadRequest req, ISquadService ss, CancellationToken ct) =>
            {
            ...
            // Get squad using id
            squads.MapGet("/{id}", async (long id, ISquadService ss, CancellationToken ct) =>
            {
            ...
            // Get all squads 
            squads.MapGet("", async (ISquadService ss, CancellationToken ct) =>
            {
            ...
            squads.MapPut("/{id}", async (long id, ISquadService ss, SquadRequest req, CancellationToken ct) =>
            {
            ...
            // Delete a squad 
            squads.MapDelete("/{id}", async (long id, ISquadService ss, CancellationToken ct) =>
            {
            ...
            squads.MapGet("/{id}/members", async (long id, ISquadService ss, CancellationToken ct) =>
            {
            ...
            squads.MapPost("/{id}/members", async (long id, SquadMemberRequest req, IPlayerService ps, ISquadService ss, CancellationToken ct) =>
            {
            ...
            squads.MapGet("/{id}/members/{puuid}", async (long id, string puuid, ISquadService ss, CancellationToken ct) =>
            {
            ...
            squads.MapDelete("/{id}/members/{puuid}", async (long id, string puuid, ISquadService ss, CancellationToken ct) =>
            {
            ...
            squads.MapGet("/{id}/matches", async (long id, ISquadService ss, IRiotService rs, IMatchService ms, ISquadMatchService sms, CancellationToken ct) =>
            {
